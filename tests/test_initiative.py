...
def test_initiative_ordered_correctly_general_case():
    ...
    """
    roster = Roster()
    roster.add_character(make_character("Party Member 1"), 14)
    roster.add_character(make_character("Party Member 2"), 4)
    roster.add_character(make_character("Party Member 3"), 17)
    roster.add_character(make_character("Party Member 4"), 8)
    roster.add_character(make_character("Monster 1", True), 15)
    roster.add_character(make_character("Monster 2", True), 18)
    roster.add_character(make_character("Monster 3", True), 20)
...
def test_initiative_ordered_correctly_shared_count():
    ...
    """
    roster = Roster()
    roster.add_character(make_character("Party Member 1"), 10)
    roster.add_character(make_character("Party Member 2"), 10)
    roster.add_character(make_character("Monster 1", True), 5)
    roster.add_character(make_character("Monster 2", True), 5)
...
def test_initiative_ordered_correctly_shared_count_enemies():
    ...
    roster.add_character(make_character("Party Member 1"), 10)
    roster.add_character(make_character("Party Member 2"), 10)
    roster.add_character(make_character("Monster 1", True), 10)
    roster.add_character(make_character("Monster 2", True), 10)
